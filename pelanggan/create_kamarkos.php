...
<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
  <h1 class="box-title" style="font-size:150%;">Pesanan</h1>
</div>
	...
	<div class="box-body"  style="width:99.5%">
      ...
      <tr>
        <div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">ID Pelanggan</label></td><td>:</td>
          <td><input type="text" class="form-control" name="id_pelanggan" placeholder="" required></td>
        </div>
      </tr>
       <tr>
        <div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Kode Pesanan</label></td><td>:</td>
          <td><input type="text" class="form-control" name="id_pelanggan" placeholder="" required></td>
        </div>
      </tr>
       <tr>
        <div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Kode Produk</label></td><td>:</td>
          <td><input type="text" class="form-control" name="id_pelanggan" placeholder="" required></td>
        </div>
      </tr>
      <!--<tr>
      ...
      <tr>
        <div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Total Pesanan</label></td><td>:</td>
