      ...
      <tr>
          ...
          <tr>
            <div class="form-group">
              ...
              <td><input type="text" class="form-control" name="jumlah" placeholder="" required></td>
            </div>
          </tr>
...
if (isset($_POST['submit'])) {
 ...
 move_uploaded_file($lokasifile,"$direktori");
       ...
       mysql_query("INSERT INTO pesanan VALUES ('','$id_pelanggan','$kd_produk','$direktori','$jumlah','$tgl_pesan','$total_bayar_pesanan','1')");
       ?>
