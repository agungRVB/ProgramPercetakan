...
<section class="content">
  <div class="row">
          <a href="?menu=pilih-pesanan" style="color:#595757;float:right;">
          ...
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            <?php
                $no=1;
                  ...
                  $sql=mysql_query("SELECT * FROM pembayaran WHERE stts !='0' AND id_pelanggan='$bc3[id_pelanggan]' ORDER BY kd_pembayaran DESC");
              ...
              <tr>
                  ...
                  <td><img src="<?php echo $bc['bukti_pembayaran']; ?>" width="200px" height="200px"></td>
                  ...
                  ?></td>
                  <!--<td align="center">
                    <a class="action" href="?menu=edit-pesanan&kd=<?php echo $bc['kd_pesanan']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
