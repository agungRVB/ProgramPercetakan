	...
	<div class="box-body"  style="width:99.5%">
      ...
      <tr>
        <div class="form-group">
          ...
          <td><input type="text" class="form-control" value="<?php echo $bc['nm_user']; ?>" name="nm_user" placeholder="" required></td>
        </div>
      </tr>
      <tr>
        <div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Password</label></td><td>:</td>
          <td><input type="text" class="form-control" value="<?php echo $bc['sandi']; ?>" name="sandi" placeholder="" required></td>
        </div>
      </tr>
      <tr>
            <div class="form-group">
              ...
              <td><div>
                  <select name="hak_akses"  class="form-control select2" required style="width:100%;">
                    <option value="<?php echo $bc['hak_akses']; ?>">
                          <?php if ($bc['hak_akses']==1) {
                            echo " Admin ";
...
if (isset($_POST['submit'])) {
  include '../config/koneksi.php';
       mysql_query("UPDATE user SET nm_user='$nm_user',sandi='$sandi',hak_akses='$hak_akses' WHERE id_user='$_GET[kd]'");
       ?>
