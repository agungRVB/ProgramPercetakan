...
<html>
  <head>
    ...
    <title>.::CV. JAYA MANDIRI PERCETAKAN::.</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-lg"><b>CV. JAYA MANDIRI</b></span>
        </a>
        ...
        <section class="sidebar"><br/>
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <pixels>Hay!!... <br> Admin<?php
                  include '../config/Koneksi.php';
                  @session_start();
                  @$sql1 = mysql_query("SELECT * FROM user WHERE namaUser='$_SESSION[username]'");
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="?menu=produk">
                 <i class="fa fa-image" style="color:orange"></i>
                 <span  style="color:orange">Produk</span>
              </a>
            </li>
            <li>
              <a href="?menu=pelanggan">
                 <i class="fa fa-users" style="color:orange"></i>
                 <span  style="color:orange">Daftar Pelanggan</span>
              </a>
            </li>
            <li>
              <a href="?menu=pesanan">
                 <i class="fa fa-dropbox" style="color:orange"></i>
                 <span  style="color:orange">Pemesanan</span>
              </a>
            </li>
            <li>
              <a href="?menu=pembayaran">
                 <i class="fa fa-money " style="color:orange"></i>
                 <span  style="color:orange">Pembayaran</span>
              </a>
            </li>
            <li>
              <a href="?menu=user">
                <i class="fa fa-user-plus" style="color:orange"></i>
                <span  style="color:orange">Kelola User</span>
              </a>
            </li>
