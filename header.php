    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="index.php">
            <div class="">
            <img src="images/logo.jpeg" width="300px" height="50px" alt="">
          </div></a>  <!--<b>ISMIYATI</b>Bus Agency</a>-->
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="?menu=cara-pesan">Cara Pemesanan</a></li>
            <li><a href="?menu=registrasi">Registrasi</a></li>
